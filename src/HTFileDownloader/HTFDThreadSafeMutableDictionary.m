//
//  HTFDThreadSafeMutableDictionary.m
//  HTFileDownloader
//
//  Created by 小丸子 on 6/7/2016.
...
@interface HTFDThreadSafeMutableDictionary()
@property (nonatomic, assign) OSSpinLock lock;
@property (nonatomic, copy) NSMutableDictionary* dictionary;
@end

@implementation HTFDThreadSafeMutableDictionary {
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:HTFDThreadSafeMutableDictionary.class]) {
        HTFDThreadSafeMutableDictionary *other = object;
